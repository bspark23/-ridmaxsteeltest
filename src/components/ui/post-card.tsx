  ...
  if (variant === 'horizontal') {
    if (actions) {
      return (
        <Card
          className={cn(
            'flex flex-col h-full py-0 overflow-hidden hover:shadow-lg transition-all duration-300 border-border/50',
            className,
          )}
          {...props}
        >
          ...
          <CardFooter className='mt-auto pt-4 border-t'>
            <div className={cn('flex items-center justify-between w-full', actionsClassName)}>
              {actions}
            </div>
          </CardFooter>
        </Card>
    ...
    return (
      <Link href={hrefLink} className='block h-full group'>
        <Card
          className={cn(
            'flex flex-col sm:flex-row h-full py-0 overflow-hidden hover:shadow-lg transition-all duration-300 border-border/50',
            className,
          )}
          {...props}
        >
  ...
  if (variant === 'featured') {
    if (actions) {
      return (
        <div className={cn('space-y-3', className)} {...props}>
          <Link href={hrefLink} className='block h-full group'>
            <Card className='relative h-full overflow-hidden hover:shadow-xl transition-all duration-300 border-none min-h-[400px]'>
              <Image
                src={post.featuredMedia.url}
                alt={post.featuredMedia.alt || post.title}
                fill
          ...
          <div className={cn('flex items-center justify-between gap-2', actionsClassName)}>
            {actions}
          </div>
        </div>
      );
    ...
    return (
      <Link href={hrefLink} className='block h-full group'>
        <Card
          className={cn(
            'relative h-full overflow-hidden hover:shadow-xl transition-all duration-300 border-none min-h-[400px]',
            className,
          )}
          {...props}
        >
