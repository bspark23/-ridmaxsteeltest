  ...
  return (
    <div className='py-14 border-b border-gray-100 last:border-0'>
      <div className='mx-auto container px-6'>
        ...
        >
          {/* Image */}
          <div className={`relative w-full rounded-2xl overflow-hidden shadow-md aspect-[4/3] bg-gray-100 ${!isEven ? 'lg:col-start-2' : ''}`}>
            {item.image ? (
              <Image
                src={item.image}
                alt={item.title}
          ...
          <div className={!isEven ? 'lg:col-start-1 lg:row-start-1' : ''}>
            ...
            <p className='text-gray-600 text-sm leading-relaxed mb-6'>{item.body}</p>
              ...
              <div className='grid sm:grid-cols-2 gap-x-6 gap-y-2'>
                {[...col1, ...col2].map((f, i) => (
                  <div key={i} className='flex items-start gap-2'>
                    ...
                    <span className='text-xs text-gray-600 leading-snug'>{f.title}</span>
                  </div>
                ))}
              </div>
            ) : null}
          ...
          <div className='mx-auto container px-6'>
            <div className='grid lg:grid-cols-2 gap-10 items-center'>
              ...
              <div>
                ...
                {whoWeServe.subtitle ? (
                  <p className='text-gray-500 text-sm mb-6'>{whoWeServe.subtitle}</p>
                ) : null}
                <div>
