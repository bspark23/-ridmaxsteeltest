...
export default function ContactPage() {
  ...
  const waAgents = (details.buttons ?? []).map((b) => ({
    title: b.title,
    href: b.href,
  }));
        ...
        <div className="mx-auto container px-6">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mb-8">{details.body ?? ""}</p>

              {/* Detail items */}
              <div className="space-y-6">
                {(details.items ?? []).map((item) => {
                  const icon = item.subtitle
              ...
              {waAgents.length > 0 ? (
                <div className="mt-8 rounded-2xl bg-green-50 border border-green-200 p-5">
                  ...
                  <p className="text-xs text-gray-500 mb-4">
                    Get instant support through WhatsApp for quick inquiries and
                    quotes.
                  </p>
                  <Button
                    type="button"
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-gray-400">
                      Enter Nigerian number (e.g. 0803...) or with country code
                      (+234...).
                    </p>
                  </div>
